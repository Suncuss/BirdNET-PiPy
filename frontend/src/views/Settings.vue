<template>
    <div class="settings p-4 max-w-4xl mx-auto">
      ...
      <div v-if="serviceRestart.restartMessage.value" class="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
        <div class="flex items-center gap-2 text-blue-700 text-sm">
          <svg class="animate-spin h-4 w-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
          </svg>
          <span>{{ serviceRestart.restartMessage.value }}</span>
        </div>
      </div>
      ...
      <div class="space-y-4">
        ...
        <!-- Detection Settings -->
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-5">
          <h2 class="text-base font-medium text-gray-800 mb-4">Detection</h2>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
        ...
        <!-- Recording Settings -->
        <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-5">
          <h2 class="text-base font-medium text-gray-800 mb-4">Recording</h2>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
          ...
          <div v-if="systemUpdate.updateAvailable.value && systemUpdate.updateInfo.value" class="mb-4 p-3 bg-blue-50 rounded-lg">
            <div class="flex items-center justify-between">
              <div>
                ...
                <p class="text-xs text-blue-600">{{ systemUpdate.updateInfo.value.commits_behind }} new commits</p>
              </div>
              <button
