  ...
  <div class="settings p-4 max-w-4xl mx-auto">
    ...
    <div class="space-y-4">
      ...
      >
        ...
        <!-- Repository Links: side by side in HA mode, stacked in native -->
        <div :class="isHomeAssistantMode ? 'flex gap-2 mt-2' : 'mt-2'">
          <a
            v-if="isHomeAssistantMode"
            href="https://github.com/alexbelgium/hassio-addons/tree/master/birdnet-pipy"
            target="_blank"
            rel="noopener noreferrer"
            class="flex-1 py-2 text-sm text-gray-600 hover:text-gray-800 hover:bg-gray-50 border border-gray-200 rounded-lg transition-colors flex items-center justify-center gap-2"
          >
            <svg
              class="w-4 h-4"
              viewBox="0 0 16 16"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            :class="isHomeAssistantMode ? 'flex-1' : 'w-full'"
            class="py-2 text-sm text-gray-600 hover:text-gray-800 hover:bg-gray-50 border border-gray-200 rounded-lg transition-colors flex items-center justify-center gap-2"
          >
            <svg
              class="w-4 h-4"
              viewBox="0 0 16 16"
