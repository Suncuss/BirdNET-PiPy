  ...
  const fetchChartsData = async (date) => {
    ...
    try {
      const [hourlyBirdActivityResponse, detailedBirdActivityResponse] =
        await Promise.all([
          axios
            .get(`${API_BASE_URL}/activity/hourly`, { params: { date } })
            .then(response => {
              logger.api('GET', `${API_BASE_URL}/activity/hourly`, { date }, response);
              return response;
            })
            .catch((error) => {
          ...
          axios
            .get(`${API_BASE_URL}/activity/overview`, { params: { date } })
            .then(response => {
              logger.api('GET', `${API_BASE_URL}/activity/overview`, { date }, response);
              return response;
            })
            .catch((error) => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const [
        ...
        axios
          .get(`${API_BASE_URL}/observations/latest`)
          .then(response => {
            logger.api('GET', `${API_BASE_URL}/observations/latest`, null, response);
            return response;
          })
          .catch((error) => {
        ...
        axios
          .get(`${API_BASE_URL}/observations/recent`)
          .then(response => {
            logger.api('GET', `${API_BASE_URL}/observations/recent`, null, response);
            return response;
          })
          .catch((error) => {
        ...
        axios
          .get(`${API_BASE_URL}/observations/summary`)
          .then(response => {
            logger.api('GET', `${API_BASE_URL}/observations/summary`, null, response);
            return response;
          })
          .catch((error) => {
      ...
      if (latestObservationData.value) {
        ...
        const wikimediaImageResponse = await axios.get(
          `${API_BASE_URL}/wikimedia_image`,
          { params: { species: latestObservationData.value.common_name } }
        );
        logger.api('GET', `${API_BASE_URL}/wikimedia_image`, 
