  ...
  <div class="update-manager p-4 bg-gray-50 rounded-lg">
    ...
    >
      ...
      >
        ...
        <!-- Changes List -->
        <div
          v-if="updateInfo.changes && updateInfo.changes.length > 0"
          class="mb-3"
        >
          ...
          <ul class="text-sm text-gray-600 list-disc list-inside space-y-1">
            <li
              v-for="change in updateInfo.changes.slice(0, 5)"
              :key="change"
            >
              {{ change }}
            </li>
            <li
              v-if="updateInfo.changes.length > 5"
              class="text-gray-400"
            >
      ...
      <div
        v-else
        class="bg-green-50 border border-green-200 p-4 rounded"
      >
    ...
    <div
      v-if="error"
      class="mt-4 bg-red-50 border border-red-200 p-4 rounded"
    >
