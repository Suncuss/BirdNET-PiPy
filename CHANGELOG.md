...
- Fixed Settings showing "Waiting for services to report the active model" and, after returning to the tab, a "Could not refresh settings" error while an update or restart was in progress. The expected outage is now reported only by the progress banner.
